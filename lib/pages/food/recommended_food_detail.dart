            ...
            child: Column(
              children: [
                Container (
                  ...
                  child: ExpandableTextWidget(text: "Paneer marinated in a spiced yoghurt is placed in a large pot, then layered with fried onions, fresh coriander cilantro, then par boiled lightly sp...."
                      "Paneer marinated in a spiced yoghurt is placed in a large pot, then layered with fried onions, fresh coriander cilantro, then par boiled lightly"
                      "Paneer marinated in a spiced yoghurt is placed in a large pot, then layered with fried onions, fresh coriander cilantro, then par boiled lightly"
                      "Paneer marinated in a spiced yoghurt is placed in a large pot, then layered with fried onions, fresh coriander cilantro, then par boiled lightly"
                      "Paneer marinated in a spiced yoghurt is placed in a large pot, then layered with fried onions, fresh coriander cilantro, then par boiled lightly"
              ...
              children: [
                GestureDetector(
                  ...
                  child: Container(
                      ...
                      child: Icon(
                        Icons.favorite,
                        color: favCheck?AppColors.heart:AppColors.signColor,
                      )
                  ),
                ),
                GestureDetector(
